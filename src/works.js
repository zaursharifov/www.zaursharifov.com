const data = [
  {
    i: `${process.env.PUBLIC_URL}/works/gerdabutter.png`,
  ...
  {
    i: `${process.env.PUBLIC_URL}/works/old_portfolio_1.png`,
  ...
  {
    i: `${process.env.PUBLIC_URL}/works/buta_project2.png`,
  ...
  {
    i: `${process.env.PUBLIC_URL}/works/old_portfolio_0.png`,
  ...
  {
    i: `${process.env.PUBLIC_URL}/works/zerapanel.png`,
    l: null,
    g: null,
  ...
  {
    i: `${process.env.PUBLIC_URL}/works/turaz.png`,
  ...
  {
    i: `${process.env.PUBLIC_URL}/works/atiktespit.png`,
    l: null,
